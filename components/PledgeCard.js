const PledgeCard = ({ name, pledge, description, items }) => {
    ...
    return (
        <div className="border-gray-100 border p-4 lg:p-8 rounded-lg">
            ...
            <div className="lg:flex justify-between space-y-4 lg:space-y-0 lg:items-center">
                ...
                <button className="text-white bg-indigo-500 px-4 py-2 lg:px-4 lg:py-3 rounded-full text-sm lg:text-base lg:font-semibold">
                    Select Reward
                </button>
            </div>
        </div>
